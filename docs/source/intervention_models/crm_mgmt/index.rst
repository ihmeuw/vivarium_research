...
This initialization scheme will require an empirical calibration phase, where the population mean LDL-C and SBP before and after initialization are compared and all simulants have an adjustment applied to their LDL-C and SBP to make sure that the age- and sex-stratified means in the model with treatment matches the means in the model without treatment.
