...
Our proposal is that we leave the general approach to risk deleted incidence the same:
...
## Chris implemented this same structure in R to produce a function that can be used to test different values of the means, standard deviations, rate, correlation, and relative risks for two risk factors.
