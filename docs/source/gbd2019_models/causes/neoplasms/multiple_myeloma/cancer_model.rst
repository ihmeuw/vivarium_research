...
.. list-table:: State Data
   ...
   * - NDMM
     - excess mortality rate
     - If treatment contains ASCT, data_dir/mortality_first_line_asct.csv, else data_dir/mortality_first_line_no_asct.csv
     -
   * - MM_first_relapse
     - prevalence
     - Derived from "burn-in" method
...
.. list-table:: Transition Data
   ...
   * - incidence_MM_first_relapse
     - NDMM
     - MM_first_relapse
     - If treatment contains ASCT, data_dir/relapse_first_line_asct.csv, else data_dir/relapse_first_line_no_asct.csv
     -
...
.. list-table:: Data sources
   ...
   * - prev_MM_{Nth}_relapse
     ...
     -
   * - emr_NDMM
     - Derived from time to death (TTD) survival analysis of Flatiron data in Line 1, conditional on ASCT
     - Don't use emr_c486
   ...
   * - emr_MM_fourth_or_higher_relapse
     ...
     -
   * - incidence_MM_first_relapse
     - Derived from time to next treatment (TTNT) survival analysis of Flatiron data in Line 1, conditional on ASCT
     -
