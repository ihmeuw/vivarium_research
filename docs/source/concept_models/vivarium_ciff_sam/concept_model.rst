...
.. list-table:: Model verification and validation tracking
   ...
   * - 5.1.2 lbwsg with observers
     ...
     - [1] `Cause model V&V plots <https://github.com/ihmeuw/vivarium_research_ciff_sam/blob/main/model_validation/model5/plots/model_5.1.2_cause_verification.pdf>`_: mortality rates a bit off, but could be a result of the underlying cause model issues that need to be investigated (noted in the table below) [2] LBWSG exposure interactive sim `notebook <https://github.com/ihmeuw/vivarium_research_ciff_sam/blob/main/model_validation/interactive_simulations/model_5/lbwsg_exposure_5.1.2.ipynb>`_ and `plots <https://github.com/ihmeuw/vivarium_research_ciff_sam/blob/main/model_validation/interactive_simulations/model_5/model_5.1.2_lbwsg_exposure_updated.pdf>`_: exposure in the late neonatal age group after 28 days of simulation run time is validating well [3] **Still need to process results specific to the simulation birthweight observers**
