...
.. list-table:: Model verification and validation tracking
   ...
   * - 4.5.7: x-factor custom paf
     - Implemented `custom x-factor PAF calculation to reflect x-factor exposure in source state of x-factor-affected transition rather than exposure in the general population <https://github.com/ihmeuw/vivarium_ciff_sam/pull/75>`_ in an attempt to fix the overestimation of SAM from model 4.5.5 
