...
.. list-table:: Outstanding verification and validation issues
   ...
   * - Wasting transition rates among simulants younger than six months of age
     ...
     - Rajan to investigate and fix bug responsible
     - ASAP (ideally before launching zinc intervention runs)
   * - Biased PAF for risk effect of wasting on diarrheal diseases excess mortality rate
     ...
     - Soon (ideally in the same run as the fix for wasting transition rate among simulants younger than six months)
