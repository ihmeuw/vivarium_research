...
suppose we have a collection of non-negative numbers :math:`w_1, w_2,\ldots,
w_n`, called **weights**, such that :math:`\sum_1^n w_i = 1`. Then the **mixture
...
density functions instead of distribution functions in the continuous case.
