...
*Incidence-based YLDs* provide a measure of the disease burden experienced by an individual over the course of their lifetime, or however many years we observe the individual. If our observation duration was long enough, an incident case of an incurable disease would accrue as many incidence-based YLDs as years left of that person's life expectancy. However, for a more relevant example to the work on our team, imagine we are evaluating DALYs among children 0-5 years old, and there was a baby with a birth defect. We would only count YLDs accumulated in the first 5 years of their life, not the YLDs that they will accumulate over the entire course of their life.
