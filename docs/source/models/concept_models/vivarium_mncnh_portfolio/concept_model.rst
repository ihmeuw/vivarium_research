...
* Our simulation models multiple interventions that act on neonatal sepsis mortality, including :ref:`probiotic supplementation in preterm neonates for infection prevention <intervention_neonatal_probiotics>` and :ref:`programs for outpatient antibiotic management of possible severe bacterial infections (PSBI) in newborns <intervention_neonatal_antibiotics>`. Our modeling strategy for the :ref:`programs for outpatient antibiotic management of possible severe bacterial infections (PSBI) in newborns <intervention_neonatal_antibiotics>` utilizes population-level impact data for interventions that offered outpatient antibiotic management options in addition to the standard of care hospital referral that is applied to the neonatal sepsis cause-specific mortality risk among the entire population. However, babies who are in the NICU for the entirety of their neonatal period by definition cannot benefit from the outpatient antibiotic management program. They can however benefit from 
