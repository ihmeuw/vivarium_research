...
.. list-table:: Model runs
  ...
  * - 16.4
    ...
    - Default
  * - 16.5
    - Artifact update to include low hemoglobin RR on postpartum depression. No need to actually re-run the model, we just need this RR value for our custom PAF calculations.
    - Baseline
    - ``model16.5``
    - Default
    - Default
