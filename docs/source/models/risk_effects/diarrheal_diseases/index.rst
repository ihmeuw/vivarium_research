...
.. math::
   ...
   \text{p\_diarrhea}_\text{{x+1}} = \frac{p_\text{D{x+1}}}{p_\text{D{x+1}}+p_\text{S{x+1}}}

.. math::

   PAF_\text{i{x}} = \frac{RR_\text{i{x}} * \text{p\_diarrhea}_\text{{x+1}} + (1 - \text{p\_diarrhea}_\text{{x+1}}) - 1}{RR_\text{i{x}} * \text{p\_diarrhea}_\text{{x+1}} + (1 - \text{p\_diarrhea}_\text{{x+1}})}
