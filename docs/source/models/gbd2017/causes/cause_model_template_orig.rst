...
.. tip::
   ...
   In the citations above, replace "Pages ???-???" with the correct page numbers
   for your cause in the two appendices, and replace the `Cause-Model-Template`
   suffix in the citation names with the name of your cause. The suffix is
   necessary because Sphinx requires citation names to be unique throughout the
   entire documentation.

   You can follow the syntax above to add your own references, and you can cite the references such as
   [GBD-2017-YLD-Capstone-Appendix-1-Cause-Model-Template]_ and
   [GBD-2017-CoD-Appendix-1-Cause-Model-Template]_ from within your text by
   enclosing the full citation name in brackets and adding a trailing
   underscore, like this: :code:`[Full-Citation-Name]_`.

   Delete this :code:`.. tip::` directive once you fill in the correct page
   numbers for your cause in the appendices.
