...
AFIB, the half of the heart that beats blood to lung is not in sync with other 3/4 of the heart
compromises the function of the heart
symptoms: fatigue (due to inefficient blood flow)
procedure: shock
aed paddles
...
risk of AFIB is that blood can accumulate in an atria and make a clot, which could cause a stroke
1-9 scale of risk. dad is 1. Risk is 1-2.5% stroke... background risk of stroke is XXX?

herbal

ablasian (cath)

dad has been taking daily baby aspirin

blood thinner is specific to the procedure

recovery--> soreness, groggy, etc.

persistent atrial fribrulation
2nd/3rd stage

cardioversion


to be done when they get back from seattle
long term

last ekg was march 2023
--> 2
...
In determining individual simulant coverage of the oral iron intervention for the :ref:`MNCNH Portfolio simulation <2024_concept_model_vivarium_mncnh_portfolio>`, see the details on the :ref:`hemoglobin module document <2024_vivarium_mncnh_portfolio_hemoglobin_module>`.
