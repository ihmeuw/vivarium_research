...
#. Re-normalize the probabilities to 1. Specifically, multiply the probabilities by :math:`\frac{1}{\text{total\_simulant}}`, where total_simulant is the sum of all probabilities for that particular simulant.
