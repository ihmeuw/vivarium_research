...
.. important::
   ...
   To begin documenting a cause in GBD 2020 for a Vivarium simulation, start by
   ...
   #. Make a subdirectory :file:`{cause_name}/` in the folder
      :file:`gbd2020/causes/` , where :file:`{cause_name}` is replaced with the
   ...
   #. Replace the `internal hyperlink target
      ...
      :code:`.. _2020_cause_model_template:` at the top of this file with a
      unique reference label for your cause. The reference label should have the
      form :samp:`.. _2020_cause_{\{cause_name\}}:`, where
      :samp:`{\{cause_name\}}` is replaced with a unique descriptive name or
      abbreviation for your cause, e.g. :code:`.. _2020_cause_measles:`.
   ...
   #. The subtitle below should now be the document's title. Replace the text
      in the below (sub)title with the full name of your cause in GBD 2020. For example, if you were modeling the cause "Neonatal encephalopathy due to birth asphyxia and birth trauma," then the title

      .. code:: reStructuredText

         ==============================
         Full Name of Cause in GBD 2020
         ==============================
...
.. admonition:: Todo for template development
  ...
  - In `Pull Request 93`_ @James suggested the following high-level
    ...
    These 3 content categories correspond to the following 3 sections below:
      ...
      2. `GBD 2020 Modeling Strategy`_
...
The following table describes any restrictions in GBD 2020 on the effects of
this cause (such as being only fatal or only nonfatal), as well as restrictions
on the ages and sexes to which the cause applies.

.. list-table:: GBD 2020 Cause Restrictions
   :widths: 15 15 20
   :header-rows: 1
...
.. todo::
  ...
  Update references to GBD 2020 once published

.. [GBD-2020-YLD-Appendix-Cause-Model-Template]
...
.. [GBD-2020-CoD-Appendix-Cause-Model-Template]
...
.. tip::
   ...
   the references such as [GBD-2020-YLD-Appendix-Cause-Model-Template]_ and
   [GBD-2020-CoD-Appendix-Cause-Model-Template]_ from within your text by
